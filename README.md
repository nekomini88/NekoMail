...
<div align="center">
  <img src="https://raw.githubusercontent.com/nekomini88/NekoMail/main/app/src/main/res/mipmap-xhdpi/ic_launcher.png" alt="NekoMail Logo" width="200"/>
</div>
...
Modifiez ce fichier pour changer le domaine par défaut sans toucher au代码。
...
- **スマートリンク処理** : 外部リンクはシステムブラウザで開き、`mailto:` リンクは標準メールクライアントを起动。  
...
#### 自動リリース
バージョンタグをプッシュすると、GitHub Actions がビルドとリリースを自动实行：
```bash
git tag v1.2
git push origin v1.2
```
